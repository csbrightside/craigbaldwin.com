...
export const totalData = {
  ...
  data: {
    ...
    datasets: [
      {
        label: 'Walk',
        data: [438.7, 858.9, 941.6, 1161.9, 1422.7, 1708.3, 1819.7, 1780.8, 1787.6, 1934.7, 1894.5, 1457.5],
        backgroundColor: 'rgba(19, 169, 160, 0.7)',
        borderWidth: 0,
      },
      {
        label: 'Run',
        data: [0, 96.4, 548.4, 1104.9, 1148.2, 853.1, 710.2, 732.6, 701.2, 452.3, 261.1, 321.7],
      ...
      {
        label: 'Car',
        data: [3226, 4181.3, 7937, 5228.8, 6021.6, 3633.9, 2977.3, 5903.8, 8103.9, 4324.3, 5910.9, 3889.4],
  ...
  data: {
    ...
    datasets: [
      ...
      },
      {
        ...
        data: [1.2, 2.62, 4.08, 6.19, 7.03, 7, 6.91, 6.85, 6.8, 6.45, 5.89, 5.59],
        type: 'line',
